...
llama_kv_cache_iswa::llama_kv_cache_iswa(
    ...
    const  layer_reuse_cb & reuse,
                     const  layer_share_cb & share,
                                      bool   is_mtp,
                                      bool   disable_dkvt) : hparams(model.hparams), unified(unified) {
    ...
    kv_base = std::make_unique<llama_kv_cache>(
            ...
            0, LLAMA_SWA_TYPE_NONE, mem_other_base, filter_base, reuse, share, is_mtp, disable_dkvt);
    ...
    kv_swa = std::make_unique<llama_kv_cache>(
            ...
            hparams.n_swa, hparams.swa_type, mem_other_swa, filter_swa, reuse, share, is_mtp, disable_dkvt);
}
